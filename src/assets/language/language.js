  ...
  "chinese": {
    ...
    upload:{
      form:{
        ...
        file_s_tips:'(上传文件单次不能大于100个且临时资料总数不能超过100个)',
        is_upload:'已上传：',
        down_name:'下载设置：',
        can_down:'可下载到U盘',
        no_down:'不可下载',
    ...
    head:{
      ...
      tips:{
        login_out:'确定退出登录吗, 是否继续?',
        quit:'退出',
        yes:'确定',
        cancel:'取消',
        pwd_length:'密码长度最少为6位',
        pwd_same:'确认密码跟新密码不一致',
        change_success:'修改成功',
        change_fail:'修改失败',
        name_length:'姓名不能为空'
      }
  ...
  "english": {
    ...
    history:{
      title:{
        ...
        meet_summary:'Minutes of meeting',
    ...
    upload:{
      form:{
        ...
        file_s_tips:'(The number of uploaded documents cannot be greater than 100 at a time and the total number of meeting materials cannot be greater than 100)',
        is_upload:'Uploaded:',
      ...
      tips:{
        ...
        del_tips:'Are you sure to delete the selected item?',
        del_title:'Delete'
      }
    },
    head:{
      ...
      tips:{
        login_out:'Are you sure you want to log out? Do you want to continue?',
        quit:'Sign out',
        yes:'Confirm',
        cancel:'Cancel',
        pwd_length:'The minimum password length is 6 digits',
        pwd_same:'The confirmation password is inconsistent with the new password',
        change_success:'Modified success',
        change_fail:'Modification failed',
        name_length:'Name cannot be empty'
      }
    }
  },
  "russian": {
    tips:{
      ...
      back:'возвращение',
      back_index:'вернуться на главную страницу',
      see:'осмотр',
      nav_title:"безбумажный центр"
    },
    index:{
      title:{
        his:'историческая конференция',
        meet:'Список конференций',
        weight_tips:"конфиденциальное заседание, необходимо обратиться к Администратору за разрешением",
        time:'время',
        host:'председательствовать',
        room:'Зал заседаний'
      },
      status:{
        not_start:'Начало',
    ...
    login:{
      tips:{
        name_txt:'Введите имя пользователя',
        pwd_txt:'Введите пароль',
        login_btn:'вход',
        name_tips:'Имя пользователя не может быть пустым',
        pwd_tips:'Пароль не может быть пустым',
        right_input:'Введите имя пользователя или пароль правильно!'
      }
    },
    history:{
      title:{
        meet_msg:'Информация о совещаниях',
        m_name:'Название сессии',
        m_time:'время проведения заседаний',
        begin_txt:'Начало',
        m_place:'место проведения сессий',
        m_host:'председательствовать',
        m_mark:'описание сеанса',
        m_users:'Список участников',
        m_case:'Повестка дня сессии',
        meet_topic:'Темы Конференции',
        meet_means:'Предварительные данные',
        meet_summary:'Резюме заседаний ',
        meet_white:'листовая плита',
        m_file:'документ',
        m_hand:'рукописный комментарий',
        m_electron:'электронная доска'
      }
    },
    topic:{
      form:{
    ...
    upload:{
      form:{
        ...
        sel_file:'Выбор файла',
        file_tips:' (Количество загруженных документов не может превышать 100, а общее число вопросов для заседаний не может превышать 200) ',
        file_s_tips:' (Количество загруженных документов не может превышать 100, а общее количество предварительной информации не может превышать 100) ',
        is_upload:'Загружено: ',
        down_name:'Параметры загрузки: ',
        can_down:'Загрузить в U - диск',
        no_down:'Не загружать ',
        is_secret:'частная модель:',
        only_watch:'только загрузчик может просмотреть ',
        all_watch:'Все нормально.',
      },
      tips:{
        file_limit_tips:"Выберите файл",
        file_only:"Я загружаю ",
        secret_type:"частная модель",
        del_tips:'Удалить выделенный элемент? ',
        del_title:'Удалить'
      }
    },
    head:{
      form:{
        info:'Личные сведения',
        account:' номер счета ',
        pwd:'пароль',
        ...
        salutatory_tips:'Введите приветствие',
        confirm_btn:'определение',
        cancel_btn:'отмена ',
        new_pwd:'новый парол',
        ag_pwd:'подтвердить пароль'
      },
      tips:{
        login_out:'Уверен, что выход из системы будет продолжаться?',
        quit:'выход',
        yes:'определение',
        cancel:'отмена',
        pwd_length:'длина пароля не менее 6 битов ',
        pwd_same:'подтвердить несогласованность пароля с новым паролем',
  ...
  "french": {
    ...
    history:{
      title:{
        ...
        meet_summary:'Aperçu des séances',
